		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Plaza Sprada - Reservas",
									"targetURL": "#sapcomplazaspradaapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapcomplazaspradaapp-display": {
								"semanticObject": "sapcomplazaspradaapp",
								"action": "display",
								"description": "Plaza Sprada - Reservas",
								"title": "Plaza Sprada - Reservas",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.com.plazaspradaapp",
									"url": sap.ui.require.toUrl("sap/com/plazaspradaapp")
								}
							}
						}
					}
